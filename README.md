...
```
![output](https://github.com/RuchithaReddy28/PCA-Matrix-Addition-With-Unified-Memory/blob/main/11.png?raw=true)
...
```
![output](https://github.com/RuchithaReddy28/PCA-Matrix-Addition-With-Unified-Memory/blob/main/22.png?raw=true)
## Result:
